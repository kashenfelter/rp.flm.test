...
```{r, simulated, message=FALSE, fig.asp=1, fig.align='center'}
# Load package
library(rp.flm.test)
...
```{r, tecator, message=FALSE, fig.asp=1, fig.align='center'}
# Load package
library(rp.flm.test)
...
```{r, aemet, message=FALSE, fig.asp=1, fig.align='center'}
# Load package
library(rp.flm.test)
